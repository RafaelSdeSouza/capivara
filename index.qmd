...
- `segment_sparse_ward()` for large cubes where exact pairwise distances are too expensive in RAM.
...
These panels were generated with the current public API on full MaNGA cubes,
so the website examples reflect real package outputs rather than placeholder
figures.
